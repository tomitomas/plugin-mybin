        ...
        if ($this->getConfiguration('type') == 'whole') {
            ...
            foreach ($eqLogics as $eqLogic) {
                ...
                if ($eqLogic->getIsEnable() == 1 && $binStatus == 1) {
                    ...
                    $binnotifs = $binnotifs . '<span class="cmd ack'.$ackCmd->getId().' cursor" data-type="info" data-subtype="binary"><span><img src="plugins/mybin/data/images/'.$binimg.'.png" width="70px"></span><span>Compteur : ' . $counterCmd->execCmd() . '</span></span>';
